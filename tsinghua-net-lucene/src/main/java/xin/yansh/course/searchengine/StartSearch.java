...
import com.hankcs.hanlp.corpus.dictionary.DictionaryMaker.Filter;
...
public class StartSearch {
	...
	public TopDocs searchQuery(String queryString, int page) throws Exception {
		return searchQuery(queryString, page, true, true, true, new String[] {}, null);
	}
	...
	public static void main(String[] args) throws Exception {
		...
		startSearch.searchQuery("建筑", 0, true, true, true, new String[] {"计算机"}, null);
